...
if [[ -d /etc/crowdsec  ]]; then
    ...
    sed -i 's/<discord-webhook>/$escaped_webhook/g' /etc/crowdsec/notifications/discord.yaml > /tmp/discord.yaml && mv /tmp/discord.yaml /etc/crowdsec/notifications/discord.yaml
